  ...
  <!-- FORM -->
    <div class="w-[340px] h-[403px] px-10 py-[25px] bg-white rounded-[10px] shadow-[6px_7px_4px_0px_rgba(0,0,0,0.10)] border-2 border-[#389012] flex-col justify-start items-start gap-5 inline-flex overflow-hidden">
      <div class="self-stretch justify-start items-center gap-1 inline-flex">
        ...
        <div class="text-[#389012] text-3xl font-semibold font-['Poppins'] leading-9">Login</div>
      </div>

      <form action="{{ route('login-process') }}" method="post" class="self-stretch h-[233px] py-2.5 flex-col justify-start items-start gap-5 flex">
        @csrf
        <div class="self-stretch h-[72px] flex-col justify-center items-start gap-2.5 flex">
          <div class="text-[#389012] text-xl font-semibold font-['Poppins'] leading-normal">Username</div>
          <input type="text" id="username" placeholder="Please insert available username" name="username" class="w-full px-4 py-2 mt-2 border text-xs rounded-lg focus:outline-none border-green-700" required>
        </div>
        
        <div class="self-stretch h-[72px] flex-col justify-center items-start gap-2.5 flex">
            <label for="password" class="w-[89px] h-6 text-[#389012] text-xl font-semibold font-['Poppins'] leading-normal">Password</label>
            <div class="flex gap-2">
                <div class="flex-1">
                    <input type="password" id="password" name="password" placeholder="Please insert correct password" class="self-stretch h-[38px] w-[210px] p-2.5 rounded-[10px] border focus:outline-none border-[#389012] text-[#389012] text-xs font-['Poppins']" required>
                </div>
                <div class="flex-none">
        ...
        <div class="self-stretch h-11 mt-10 flex-col justify-center items-center gap-2.5 flex">
