                                    ...
                                    <form action="{{ route('menu.update', $menu->id_menu) }}" method="post" class="self-stretch h-[276px] py-2.5 flex-col justify-start items-start gap-5 flex" enctype="multipart/form-data">
                                        ...
                                        <div class="self-stretch h-[72px] flex-col justify-center items-start gap-2.5 flex">
                                            ...
                                            <div class="flex gap-2">
                                                <div class="flex-1">
                                                    <input type="text" id="fileNameEditDisplay" name="fileNameEditDisplay" class="self-stretch h-[38px] w-[560px] rounded-[10px] border border-[#389012] bg-[#389012] bg-opacity-20 text-[#389012] text-xs font-semibold font-['Poppins'] pl-2 text-left" disabled />
                                                    <input type="file" id="imageEdit_name" hidden name="imageEdit_name" class="self-stretch h-[38px] w-[560px] rounded-[10px] border border-[#389012] text-[#389012] text-xs font-semibold font-['Poppins']" accept="image/jpeg, image/png, image/jpg, image/svg" onchange="updateFileName()">
                                                </div>
                                                <div class="flex-none">
                                                    <button type="button" class="self-stretch w-[150px] p-2.5 rounded-[10px] border border-[#389012] text-[#389012] text-xs font-semibold font-['Poppins'] flex justify-center items-center" onclick="document.getElementById('imageEdit_name').click()">
                                                        Pilih file
                                                    </button>
                                                </div>
                                            </div>
